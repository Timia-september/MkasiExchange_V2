...
<body class="bg-light">
    ...
    <div class="container mt-5">
        <h2 class="fw-bold mb-4"><?php echo $words['admin_title'] ?? 'Admin Management Control'; ?></h2>
        
        <div class="row mb-5">
            <div class="col-md-4">
                <div class="card bg-primary text-white shadow-sm border-0 p-3">
                    <h3><?php echo $user_count; ?></h3>
                    <p class="mb-0"><?php echo $words['total_users'] ?? 'Total Registered Users'; ?></p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-success text-white shadow-sm border-0 p-3">
                    <h3><?php echo $product_count; ?></h3>
                    <p class="mb-0"><?php echo $words['active_listings'] ?? 'Active Listings'; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <h4 class="mb-3"><?php echo $words['recent_listings'] ?? 'Recent Listings'; ?></h4>
                <table class="table table-hover">
                    <thead class="table-dark">
                        <tr>
                            <th><?php echo $words['item_header'] ?? 'Item'; ?></th>
                            <th><?php echo $words['price_label'] ?? 'Price'; ?></th>
                            <th><?php echo $words['location'] ?? 'Location'; ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="delete_item.php?id=<?php echo $item['id']; ?>" class="btn btn-danger btn-sm"><?php echo $words['delete_btn'] ?? 'Delete'; ?></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
